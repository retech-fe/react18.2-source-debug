...
export const enableTransitionTracing = __VARIANT__; // Enable this flag to help with concurrent mode debugging.
...
export const replayFailedUnitOfWorkWithInvokeGuardedCallback = __DEV__; // TODO: These flags are hard-coded to the default values used in open source.
...
export const enableFloat = false; // You probably *don't* want to add more hardcoded ones.
