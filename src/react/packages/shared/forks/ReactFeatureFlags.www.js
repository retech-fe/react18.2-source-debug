...
export const enableUseEventHook = true; // Logs additional User Timing API marks for use with an experimental profiling tool.
...
export const useModernStrictMode = false; // Flow magic to verify the exports of this file match the original version.
