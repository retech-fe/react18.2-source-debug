...
import { ClassComponent, FunctionComponent, HostComponent, HostResource, HostText } from 'react-reconciler/src/ReactWorkTags';
...
function findAllInRenderedFiberTreeInternal(fiber, test) {
  ...
  while (true) {
    if (node.tag === HostComponent || node.tag === HostText || node.tag === ClassComponent || node.tag === FunctionComponent || (enableFloat ? node.tag === HostResource : false)) {
