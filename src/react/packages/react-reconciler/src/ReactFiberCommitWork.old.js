    ...
    if ((finishedWork.flags & Update) !== NoFlags) {
      switch (finishedWork.tag) {
        case Profiler: {
          ...
          const { id, onPostCommit } = finishedWork.memoizedProps; // This value will still reflect the previous commit phase.
    ...
    if (markerTransitions !== null) {
      ...
      deletedTransitions.forEach((transition) => {
        ...
        if (
          ...
          (markerInstance.aborts === null || !markerInstance.aborts.includes(abort))
        ) {
...
function recursivelyTraverseReappearLayoutEffects(finishedRoot, parentFiber, includeWorkInProgressEffects) {
  ...
  const childShouldIncludeWorkInProgressEffects =
    includeWorkInProgressEffects && (parentFiber.subtreeFlags & LayoutMask) !== NoFlags; // TODO (Offscreen) Check: flags & (RefStatic | LayoutStatic)
...
function recursivelyTraverseReconnectPassiveEffects(
  ...
  // node was reused.
  const childShouldIncludeWorkInProgressEffects =
    includeWorkInProgressEffects && (parentFiber.subtreeFlags & PassiveMask) !== NoFlags; // TODO (Offscreen) Check: flags & (RefStatic | LayoutStatic)
