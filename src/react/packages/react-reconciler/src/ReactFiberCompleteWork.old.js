...
import { createInstance, createTextInstance, appendInitialChild, finalizeInitialChildren, prepareUpdate, supportsMutation, supportsPersistence, supportsResources, cloneInstance, cloneHiddenInstance, cloneHiddenTextInstance, createContainerChildSet, appendChildToContainerChildSet, finalizeContainerChildren, preparePortalMount, prepareScopeUpdate } from './ReactFiberHostConfig';
import { getRootHostContainer, popHostContext, getHostContext, popHostContainer } from './ReactFiberHostContext.old';
import { suspenseStackCursor, popSuspenseListContext, popSuspenseHandler, pushSuspenseListContext, setShallowSuspenseListContext, ForceSuspenseFallback, setDefaultShallowSuspenseListContext } from './ReactFiberSuspenseContext.old';
import { popHiddenContext, isCurrentTreeHidden } from './ReactFiberHiddenContext.old';
...
import { enableSuspenseCallback, enableScopeAPI, enableProfilerTimer, enableCache, enableTransitionTracing, enableFloat } from 'shared/ReactFeatureFlags';
        ...
        if (nextDidTimeout !== prevDidTimeout) {
          ...
          if (nextDidTimeout) {
            ...
            if ((workInProgress.mode & ConcurrentMode) !== NoMode) {
              ...
              enableSuspenseAvoidThisFallback && workInProgress.memoizedProps.unstable_avoidThisFallback === true;
