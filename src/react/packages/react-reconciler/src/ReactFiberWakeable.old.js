...
let adHocSuspendCount = 0; // TODO: Sparse arrays are bad for performance.
...
export function throwIfInfinitePingLoopDetected() {
  if (adHocSuspendCount > MAX_AD_HOC_SUSPEND_COUNT) {// TODO: Guard against an infinite loop by throwing an error if the same
