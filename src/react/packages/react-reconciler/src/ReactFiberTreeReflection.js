...
import { ClassComponent, HostComponent, HostResource, HostRoot, HostPortal, HostText, SuspenseComponent } from './ReactWorkTags';
...
function findCurrentHostFiberImpl(node) {
  ...
  if (node.tag === HostComponent || node.tag === HostText || (enableFloat ? node.tag === HostResource : false)) {
    return node;
  }
