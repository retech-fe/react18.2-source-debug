...
import { trackUsedThenable, getPreviouslyUsedThenableAtIndex } from "./ReactFiberWakeable.old";
...
export function renderWithHooks(current, workInProgress, Component, props, secondArg, nextRenderLanes) {
  ...
  if (__DEV__) {
    ...
    if (
      current !== null &&
      (current.flags & StaticMaskEffect) !== (workInProgress.flags & StaticMaskEffect) && // Disable this warning in legacy mode, because legacy Suspense is weird
