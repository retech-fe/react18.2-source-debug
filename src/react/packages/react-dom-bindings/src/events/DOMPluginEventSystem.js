...
import { HostRoot, HostPortal, HostComponent, HostResource, HostText, ScopeComponent } from 'react-reconciler/src/ReactWorkTags';
...
import { enableLegacyFBSupport, enableCreateEventHandleAPI, enableScopeAPI, enableFloat } from 'shared/ReactFeatureFlags';
      ...
      mainLoop: while (true) {
        ...
        if (nodeTag === HostRoot || nodeTag === HostPortal) {
          ...
          while (container !== null) {
            ...
            if (parentTag === HostComponent || parentTag === HostText || (enableFloat ? parentTag === HostResource : false)) {
...
export function accumulateSinglePhaseListeners(targetFiber, reactName, nativeEventType, inCapturePhase, accumulateTargetOnly, nativeEvent) {
  ...
  while (instance !== null) {
    ...
    if ((tag === HostComponent || (enableFloat ? tag === HostResource : false)) && stateNode !== null) {
